    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div class="flex gap-2 overflow-x-auto pb-2">
                    {#each product.images as img}
                        <button 
                            ...
                            {selectedImage === img ? 'border-green-600' : 'border-gray-200 hover:border-gray-400'}"
                        >
        ...
        <div class="lg:col-span-4">
            ...
            <div class="flex items-center gap-2 mb-2 text-sm text-gray-500">
                <span class="font-bold text-green-600">{product.brand || 'No Brand'}</span>
                <span>•</span>
            ...
            <div class="flex gap-2 mb-4">
                {#each product.tags as tag}
                    <span class="bg-gray-100 text-gray-600 text-xs px-2 py-1 rounded-md capitalize">#{tag}</span>
                {/each}
            </div>
            {/if}
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 text-sm">
                        ...
                        <div class="grid grid-cols-[140px_1fr] gap-y-3">
                            ...
                            <span class="font-medium text-green-600">{product.availabilityStatus}</span>

                            <span class="text-gray-500">stock</span>
                            <span>{product.stock} pcs</span>

                            <span class="text-gray-500">Min. Order</span>
                            <span>{product.minimumOrderQuantity} pcs</span>
                    ...
                    <div class="border-t border-gray-200 pt-4 text-xs text-gray-500 flex justify-between items-end">
                        <div>
        ...
        <div class="hidden lg:block lg:col-span-4">
            <div class="sticky top-24 border border-gray-200 rounded-xl p-4 shadow-sm bg-white">
                <h3 class="font-bold text-lg mb-4">Review ({product.reviews.length})</h3>
                
                <div class="space-y-4 animate-fadeIn">
                    {#each product.reviews as review}
                        <div class="border border-gray-100 rounded-lg p-4 shadow-sm bg-white">
                            <div class="flex justify-between items-start mb-2">
                                <div>
                                    <p class="font-bold text-sm text-gray-900">{review.reviewerName}</p>
